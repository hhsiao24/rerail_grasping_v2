...
if("TRUE" STREQUAL "TRUE")
  set(rail_manipulation_msgs_SOURCE_PREFIX /home/hannah/hannah_ws/src/rerail_stretchit_grasp/rail_manipulation_msgs)
  set(rail_manipulation_msgs_DEVEL_PREFIX /home/hannah/hannah_ws/devel)
  ...
  set(rail_manipulation_msgs_INSTALL_PREFIX /home/hannah/hannah_ws/install)
...
if(NOT "/home/hannah/hannah_ws/devel/include " STREQUAL " ")
  ...
  if(NOT "https://github.com/GT-RAIL/rail_manipulation_msgs/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/GT-RAIL/rail_manipulation_msgs/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/rail_manipulation_msgs " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/rail_manipulation_msgs' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'David Kent <dekent@gatech.edu>, Russell Toris <russell.toris@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rail_manipulation_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rail_manipulation_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hannah/hannah_ws/src/rerail_stretchit_grasp/rail_manipulation_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rail_manipulation_msgs_NUM_DUMMY_TARGETS)
      set(rail_manipulation_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rail_manipulation_msgs::wrapped-linker-option${rail_manipulation_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rail_manipulation_msgs_NUM_DUMMY_TARGETS "${rail_manipulation_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rail_manipulation_msgs::wrapped-linker-option${rail_manipulation_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rail_manipulation_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rail_manipulation_msgs_EXPORTED_TARGETS ${${rail_manipulation_msgs_dep}_EXPORTED_TARGETS})
endforeach()
