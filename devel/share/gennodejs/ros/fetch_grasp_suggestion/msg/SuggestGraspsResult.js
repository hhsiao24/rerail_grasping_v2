...
let RankedGraspList = require('./RankedGraspList.js');

//-----------------------------------------------------------

class SuggestGraspsResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SuggestGraspsResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SuggestGraspsResult(null);
...
module.exports = SuggestGraspsResult;
