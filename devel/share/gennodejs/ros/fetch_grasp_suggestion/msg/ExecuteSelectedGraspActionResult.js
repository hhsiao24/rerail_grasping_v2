...
let ExecuteSelectedGraspResult = require('./ExecuteSelectedGraspResult.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class ExecuteSelectedGraspActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ExecuteSelectedGraspResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteSelectedGraspResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteSelectedGraspActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = ExecuteSelectedGraspResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteSelectedGraspActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ExecuteSelectedGraspResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ExecuteSelectedGraspResult()
    }
...
module.exports = ExecuteSelectedGraspActionResult;
