...
class SegmentObjectsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentObjectsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentObjectsRequest
    let len;
    let data = new SegmentObjectsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentObjectsRequest(null);
    return resolved;
    }
};

class SegmentObjectsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentObjectsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentObjectsResponse
    let len;
    let data = new SegmentObjectsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'rail_manipulation_msgs/SegmentObjectsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentObjectsResponse(null);
...
module.exports = {
  Request: SegmentObjectsRequest,
  Response: SegmentObjectsResponse,
  md5sum() { return '924369697b1d59bf060481bc93dca47a'; },
  datatype() { return 'rail_manipulation_msgs/SegmentObjects'; }
};
