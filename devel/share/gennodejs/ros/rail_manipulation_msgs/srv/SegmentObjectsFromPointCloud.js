...
let SegmentedObjectList = require('../msg/SegmentedObjectList.js');

//-----------------------------------------------------------

class SegmentObjectsFromPointCloudRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentObjectsFromPointCloudRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentObjectsFromPointCloudRequest
    let len;
    let data = new SegmentObjectsFromPointCloudRequest(null);
  ...
  static datatype() {
    ...
    return 'rail_manipulation_msgs/SegmentObjectsFromPointCloudRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentObjectsFromPointCloudRequest(null);
...
class SegmentObjectsFromPointCloudResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.segmented_objects = null;
    }
    else {
      if (initObj.hasOwnProperty('segmented_objects')) {
        this.segmented_objects = initObj.segmented_objects
      }
      else {
        this.segmented_objects = new SegmentedObjectList();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentObjectsFromPointCloudResponse
    // Serialize message field [segmented_objects]
    bufferOffset = SegmentedObjectList.serialize(obj.segmented_objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentObjectsFromPointCloudResponse
    let len;
    let data = new SegmentObjectsFromPointCloudResponse(null);
    // Deserialize message field [segmented_objects]
    data.segmented_objects = SegmentedObjectList.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += SegmentedObjectList.getMessageSize(object.segmented_objects);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'rail_manipulation_msgs/SegmentObjectsFromPointCloudResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentObjectsFromPointCloudResponse(null);
    if (msg.segmented_objects !== undefined) {
      resolved.segmented_objects = SegmentedObjectList.Resolve(msg.segmented_objects)
    }
    else {
      resolved.segmented_objects = new SegmentedObjectList()
    }
...
module.exports = {
  Request: SegmentObjectsFromPointCloudRequest,
  Response: SegmentObjectsFromPointCloudResponse,
  md5sum() { return '4aa9a2e55c16c84b6ab41ce5ebf01032'; },
  datatype() { return 'rail_manipulation_msgs/SegmentObjectsFromPointCloud'; }
};
