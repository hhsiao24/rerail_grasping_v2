...
class SegmentedObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cielab')) {
        this.cielab = initObj.cielab
      }
      else {
        this.cielab = [];
      }
      ...
      if (initObj.hasOwnProperty('image_indices')) {
        this.image_indices = initObj.image_indices
      }
      else {
        this.image_indices = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.rgb, buffer, bufferOffset, null);
    // Serialize message field [cielab]
    bufferOffset = _arraySerializer.float32(obj.cielab, buffer, bufferOffset, null);
    ...
    // Serialize message field [image_indices]
    bufferOffset = _arraySerializer.int32(obj.image_indices, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.rgb = _arrayDeserializer.float32(buffer, bufferOffset, null)
    // Deserialize message field [cielab]
    data.cielab = _arrayDeserializer.float32(buffer, bufferOffset, null)
    ...
    // Deserialize message field [image_indices]
    data.image_indices = _arrayDeserializer.int32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.rgb.length;
    length += 4 * object.cielab.length;
    ...
    length += 4 * object.image_indices.length;
    return length + 137;
  }
  ...
  static md5sum() {
    ...
    return '25788794262e05da1b57fce51ce4875c';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cielab !== undefined) {
      resolved.cielab = msg.cielab;
    }
    else {
      resolved.cielab = []
    }
    ...
    if (msg.image_indices !== undefined) {
      resolved.image_indices = msg.image_indices;
    }
    else {
      resolved.image_indices = []
    }
