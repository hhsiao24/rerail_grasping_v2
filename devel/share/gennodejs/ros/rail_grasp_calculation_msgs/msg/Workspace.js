...
class Workspace {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('roiCenter')) {
        ...
        this.roiCenter = new geometry_msgs.msg.Point();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = geometry_msgs.msg.Point.serialize(obj.roiCenter, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.roiCenter = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.roiCenter !== undefined) {
      resolved.roiCenter = geometry_msgs.msg.Point.Resolve(msg.roiCenter)
    }
    else {
      resolved.roiCenter = new geometry_msgs.msg.Point()
    }
