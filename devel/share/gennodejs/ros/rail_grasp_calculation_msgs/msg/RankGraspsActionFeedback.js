...
class RankGraspsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RankGraspsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RankGraspsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RankGraspsActionFeedback(null);
    ...
    data.feedback = RankGraspsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RankGraspsFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RankGraspsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RankGraspsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RankGraspsFeedback()
    }
...
module.exports = RankGraspsActionFeedback;
