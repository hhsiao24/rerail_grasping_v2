...
(cl:defmethod cl:initialize-instance :after ((m <StretchSegmentation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StretchSegmentation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stretch_fetch_grasp_bridge-srv:<StretchSegmentation-request> is deprecated: use stretch_fetch_grasp_bridge-srv:StretchSegmentation-request instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <StretchSegmentation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stretch_fetch_grasp_bridge-srv:object_name-val is deprecated.  Use stretch_fetch_grasp_bridge-srv:object_name instead.")
  (object_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StretchSegmentation-request>)))
  ...
  "stretch_fetch_grasp_bridge/StretchSegmentationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StretchSegmentation-request)))
  "Returns string type for a service object of type 'StretchSegmentation-request"
  "stretch_fetch_grasp_bridge/StretchSegmentationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StretchSegmentation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StretchSegmentation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stretch_fetch_grasp_bridge-srv:<StretchSegmentation-response> is deprecated: use stretch_fetch_grasp_bridge-srv:StretchSegmentation-response instead.")))
...
(cl:defmethod segmented_point_cloud-val ((m <StretchSegmentation-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stretch_fetch_grasp_bridge-srv:segmented_point_cloud-val is deprecated.  Use stretch_fetch_grasp_bridge-srv:segmented_point_cloud instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StretchSegmentation-response>)))
  ...
  "stretch_fetch_grasp_bridge/StretchSegmentationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StretchSegmentation-response)))
  "Returns string type for a service object of type 'StretchSegmentation-response"
  "stretch_fetch_grasp_bridge/StretchSegmentationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StretchSegmentation)))
  ...
  "stretch_fetch_grasp_bridge/StretchSegmentation")