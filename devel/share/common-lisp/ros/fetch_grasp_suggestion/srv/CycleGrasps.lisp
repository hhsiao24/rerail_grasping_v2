...
(cl:defmethod cl:initialize-instance :after ((m <CycleGrasps-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CycleGrasps-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_grasp_suggestion-srv:<CycleGrasps-request> is deprecated: use fetch_grasp_suggestion-srv:CycleGrasps-request instead.")))

(cl:ensure-generic-function 'forward-val :lambda-list '(m))
(cl:defmethod forward-val ((m <CycleGrasps-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_grasp_suggestion-srv:forward-val is deprecated.  Use fetch_grasp_suggestion-srv:forward instead.")
  (forward m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CycleGrasps-request>)))
  ...
  "fetch_grasp_suggestion/CycleGraspsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CycleGrasps-request)))
  "Returns string type for a service object of type 'CycleGrasps-request"
  "fetch_grasp_suggestion/CycleGraspsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CycleGrasps-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CycleGrasps-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_grasp_suggestion-srv:<CycleGrasps-response> is deprecated: use fetch_grasp_suggestion-srv:CycleGrasps-response instead.")))

(cl:ensure-generic-function 'grasp-val :lambda-list '(m))
(cl:defmethod grasp-val ((m <CycleGrasps-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_grasp_suggestion-srv:grasp-val is deprecated.  Use fetch_grasp_suggestion-srv:grasp instead.")
  (grasp m))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <CycleGrasps-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_grasp_suggestion-srv:index-val is deprecated.  Use fetch_grasp_suggestion-srv:index instead.")
  (index m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CycleGrasps-response>)))
  ...
  "fetch_grasp_suggestion/CycleGraspsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CycleGrasps-response)))
  "Returns string type for a service object of type 'CycleGrasps-response"
  "fetch_grasp_suggestion/CycleGraspsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CycleGrasps)))
  ...
  "fetch_grasp_suggestion/CycleGrasps")