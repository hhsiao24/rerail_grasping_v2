...
(cl:defclass <Grasps> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grasps
    :reader grasps
    :initarg :grasps
    :type (cl:vector rail_agile-msg:Grasp)
   :initform (cl:make-array 0 :element-type 'rail_agile-msg:Grasp :initial-element (cl:make-instance 'rail_agile-msg:Grasp))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rail_agile-msg:<Grasps> is deprecated: use rail_agile-msg:Grasps instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Grasps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile-msg:header-val is deprecated.  Use rail_agile-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <Grasps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile-msg:grasps-val is deprecated.  Use rail_agile-msg:grasps instead.")
  (grasps m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Grasps>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grasps)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rail_agile-msg:Grasp))
