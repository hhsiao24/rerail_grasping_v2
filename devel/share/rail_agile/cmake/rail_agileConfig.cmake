...
if(rail_agile_CONFIG_INCLUDED)
  return()
endif()
set(rail_agile_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(rail_agile_SOURCE_PREFIX /home/hannah/hannah_ws/src/rerail_stretchit_grasp/rail_agile)
  set(rail_agile_DEVEL_PREFIX /home/hannah/hannah_ws/devel)
  set(rail_agile_INSTALL_PREFIX "")
  set(rail_agile_PREFIX ${rail_agile_DEVEL_PREFIX})
else()
  set(rail_agile_SOURCE_PREFIX "")
  set(rail_agile_DEVEL_PREFIX "")
  set(rail_agile_INSTALL_PREFIX /home/hannah/hannah_ws/install)
  set(rail_agile_PREFIX ${rail_agile_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'rail_agile' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND rail_agile_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hannah/hannah_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(rail_agile_LIBRARY_DIRS ${lib_path})
      list(APPEND rail_agile_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'rail_agile'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND rail_agile_LIBRARIES ${lib})
    endif()
  endif()
...
set(rail_agile_EXPORTED_TARGETS "rail_agile_generate_messages_cpp;rail_agile_generate_messages_eus;rail_agile_generate_messages_lisp;rail_agile_generate_messages_nodejs;rail_agile_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${rail_agile_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cmake_modules;cv_bridge;eigen_conversions;geometry_msgs;message_runtime;pcl_conversions;roscpp;sensor_msgs;std_msgs;visualization_msgs;tf;tf_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 rail_agile_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${rail_agile_dep}_FOUND)
      find_package(${rail_agile_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rail_agile_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(rail_agile_INCLUDE_DIRS ${${rail_agile_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(rail_agile_LIBRARIES ${rail_agile_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${rail_agile_dep}_LIBRARIES})
  _list_append_deduplicate(rail_agile_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(rail_agile_LIBRARIES ${rail_agile_LIBRARIES})

  _list_append_unique(rail_agile_LIBRARY_DIRS ${${rail_agile_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(rail_agile_EXPORTED_TARGETS ${${rail_agile_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "rail_agile-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${rail_agile_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
