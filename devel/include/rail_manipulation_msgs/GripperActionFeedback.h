...
bool operator==(const ::rail_manipulation_msgs::GripperActionFeedback_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::GripperActionFeedback_<ContainerAllocator2> & rhs)
{
