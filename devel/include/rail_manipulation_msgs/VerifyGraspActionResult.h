...
bool operator==(const ::rail_manipulation_msgs::VerifyGraspActionResult_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::VerifyGraspActionResult_<ContainerAllocator2> & rhs)
{
