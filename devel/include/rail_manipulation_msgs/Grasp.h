...
struct Grasp_
{
  ...
  _grasp_pose_type grasp_pose;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _eef_frame_id_type;
...
bool operator==(const ::rail_manipulation_msgs::Grasp_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::Grasp_<ContainerAllocator2> & rhs)
{
  return lhs.grasp_pose == rhs.grasp_pose &&
    lhs.eef_frame_id == rhs.eef_frame_id &&
...
struct Printer< ::rail_manipulation_msgs::Grasp_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rail_manipulation_msgs::Grasp_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.eef_frame_id);
    s << indent << "grasp_id: ";
