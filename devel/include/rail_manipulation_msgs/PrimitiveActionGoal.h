...
bool operator==(const ::rail_manipulation_msgs::PrimitiveActionGoal_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::PrimitiveActionGoal_<ContainerAllocator2> & rhs)
{
