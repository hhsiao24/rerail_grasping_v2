...
struct SegmentedObject_
{
  ...
  _center_type center;
   ...
   typedef  ::rail_manipulation_msgs::BoundingVolume_<ContainerAllocator>  _bounding_volume_type;
  ...
  _height_type height;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _rgb_type;
  _rgb_type rgb;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _cielab_type;
  _cielab_type cielab;
  ...
  _confidence_type confidence;
   ...
   typedef std::vector< ::rail_manipulation_msgs::Grasp_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rail_manipulation_msgs::Grasp_<ContainerAllocator> >> _grasps_type;
  _grasps_type grasps;

   typedef  ::visualization_msgs::Marker_<ContainerAllocator>  _marker_type;
  _marker_type marker;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _image_indices_type;
  _image_indices_type image_indices;
...
bool operator==(const ::rail_manipulation_msgs::SegmentedObject_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::SegmentedObject_<ContainerAllocator2> & rhs)
{
  return lhs.point_cloud == rhs.point_cloud &&
    ...
    lhs.rgb == rhs.rgb &&
    lhs.cielab == rhs.cielab &&
    lhs.orientation == rhs.orientation &&
    lhs.recognized == rhs.recognized &&
    lhs.name == rhs.name &&
    lhs.model_id == rhs.model_id &&
    lhs.confidence == rhs.confidence &&
    lhs.grasps == rhs.grasps &&
    lhs.marker == rhs.marker &&
    lhs.image_indices == rhs.image_indices;
}
...
struct MD5Sum< ::rail_manipulation_msgs::SegmentedObject_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x25788794262e05daULL;
  static const uint64_t static_value2 = 0x1b57fce51ce4875cULL;
};
...
struct Printer< ::rail_manipulation_msgs::SegmentedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rail_manipulation_msgs::SegmentedObject_<ContainerAllocator>& v)
  {
    ...
    s << std::endl;
    Printer< ::rail_manipulation_msgs::BoundingVolume_<ContainerAllocator> >::stream(s, indent + "  ", v.bounding_volume);
    s << indent << "width: ";
    ...
    {
      s << indent << "  rgb[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.rgb[i]);
    }
    s << indent << "cielab[]" << std::endl;
    for (size_t i = 0; i < v.cielab.size(); ++i)
    {
      s << indent << "  cielab[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.cielab[i]);
    }
    ...
    s << indent << "image_indices[]" << std::endl;
    for (size_t i = 0; i < v.image_indices.size(); ++i)
    {
      s << indent << "  image_indices[" << i << "]: ";
      Printer<int32_t>::stream(s, indent + "  ", v.image_indices[i]);
    }
  }
};
