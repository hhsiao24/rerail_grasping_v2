...
bool operator==(const ::rail_manipulation_msgs::RecognizeObjectActionGoal_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::RecognizeObjectActionGoal_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::rail_manipulation_msgs::RecognizeObjectActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "0974c7bcdc82f985281fb6c896c21fa2";
  }

  static const char* value(const ::rail_manipulation_msgs::RecognizeObjectActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0974c7bcdc82f985ULL;
  static const uint64_t static_value2 = 0x281fb6c896c21fa2ULL;
};
