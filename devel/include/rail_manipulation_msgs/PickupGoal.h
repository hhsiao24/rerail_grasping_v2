...
bool operator==(const ::rail_manipulation_msgs::PickupGoal_<ContainerAllocator1> & lhs, const ::rail_manipulation_msgs::PickupGoal_<ContainerAllocator2> & rhs)
{
  return lhs.pose == rhs.pose &&
    lhs.lift == rhs.lift &&
    lhs.verify == rhs.verify &&
    lhs.attachObject == rhs.attachObject;
}
