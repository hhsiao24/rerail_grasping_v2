...
"""autogenerated by genpy from rail_grasp_calculation_msgs/SampleGraspsAction.msg. Do not edit."""
import codecs
import sys
...
class SampleGraspsAction(genpy.Message):
  _md5sum = "396a367a9bdb1f4f74946fec47f96c00"
  _type = "rail_grasp_calculation_msgs/SampleGraspsAction"
...
"""
  ...
  _slot_types = ['rail_grasp_calculation_msgs/SampleGraspsActionGoal','rail_grasp_calculation_msgs/SampleGraspsActionResult','rail_grasp_calculation_msgs/SampleGraspsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SampleGraspsAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rail_grasp_calculation_msgs.msg.SampleGraspsActionGoal()
      if self.action_result is None:
        self.action_result = rail_grasp_calculation_msgs.msg.SampleGraspsActionResult()
      if self.action_feedback is None:
        self.action_feedback = rail_grasp_calculation_msgs.msg.SampleGraspsActionFeedback()
    else:
      self.action_goal = rail_grasp_calculation_msgs.msg.SampleGraspsActionGoal()
      self.action_result = rail_grasp_calculation_msgs.msg.SampleGraspsActionResult()
      self.action_feedback = rail_grasp_calculation_msgs.msg.SampleGraspsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.cloud.header.seq, _x.action_goal.goal.cloud.header.stamp.secs, _x.action_goal.goal.cloud.header.stamp.nsecs))
      _x = self.action_goal.goal.cloud.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_goal.goal.cloud.height, _x.action_goal.goal.cloud.width))
      length = len(self.action_goal.goal.cloud.fields)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.cloud.fields:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_B2I().pack(_x.action_goal.goal.cloud.is_bigendian, _x.action_goal.goal.cloud.point_step, _x.action_goal.goal.cloud.row_step))
      _x = self.action_goal.goal.cloud.data
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.cloud.header.seq, _x.action_goal.goal.cloud.header.stamp.secs, _x.action_goal.goal.cloud.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.cloud.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.action_goal.goal.cloud.height, _x.action_goal.goal.cloud.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.cloud.fields = []
      for i in range(0, length):
        ...
        self.action_goal.goal.cloud.fields.append(val1)
      _x = self
      start = end
      end += 9
      (_x.action_goal.goal.cloud.is_bigendian, _x.action_goal.goal.cloud.point_step, _x.action_goal.goal.cloud.row_step,) = _get_struct_B2I().unpack(str[start:end])
      self.action_goal.goal.cloud.is_bigendian = bool(self.action_goal.goal.cloud.is_bigendian)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_goal.goal.cloud.data = str[start:end]
      _x = self
      start = end
      end += 110
      (_x.action_goal.goal.cloud.is_dense, _x.action_goal.goal.workspace.mode, _x.action_goal.goal.workspace.x_min, _x.action_goal.goal.workspace.x_max, _x.action_goal.goal.workspace.y_min, _x.action_goal.goal.workspace.y_max, _x.action_goal.goal.workspace.z_min, _x.action_goal.goal.workspace.z_max, _x.action_goal.goal.workspace.roiCenter.x, _x.action_goal.goal.workspace.roiCenter.y, _x.action_goal.goal.workspace.roiCenter.z, _x.action_goal.goal.workspace.roiDimensions.x, _x.action_goal.goal.workspace.roiDimensions.y, _x.action_goal.goal.workspace.roiDimensions.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2B12d3I().unpack(str[start:end])
      self.action_goal.goal.cloud.is_dense = bool(self.action_goal.goal.cloud.is_dense)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
