...
class SegmentedObject(genpy.Message):
  _md5sum = "25788794262e05da1b57fce51ce4875c"
...
float32 a
"""
  __slots__ = ['point_cloud','image','centroid','center','bounding_volume','width','depth','height','rgb','cielab','orientation','recognized','name','model_id','confidence','grasps','marker','image_indices']
  _slot_types = ['sensor_msgs/PointCloud2','sensor_msgs/Image','geometry_msgs/Point','geometry_msgs/Point','rail_manipulation_msgs/BoundingVolume','float64','float64','float64','float32[]','float32[]','geometry_msgs/Quaternion','bool','string','uint32','float64','rail_manipulation_msgs/Grasp[]','visualization_msgs/Marker','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       point_cloud,image,centroid,center,bounding_volume,width,depth,height,rgb,cielab,orientation,recognized,name,model_id,confidence,grasps,marker,image_indices
    ...
    if args or kwds:
      ...
      if self.bounding_volume is None:
        self.bounding_volume = rail_manipulation_msgs.msg.BoundingVolume()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6d3I().pack(_x.centroid.x, _x.centroid.y, _x.centroid.z, _x.center.x, _x.center.y, _x.center.z, _x.bounding_volume.pose.header.seq, _x.bounding_volume.pose.header.stamp.secs, _x.bounding_volume.pose.header.stamp.nsecs))
      _x = self.bounding_volume.pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_13d().pack(_x.bounding_volume.pose.pose.position.x, _x.bounding_volume.pose.pose.position.y, _x.bounding_volume.pose.pose.position.z, _x.bounding_volume.pose.pose.orientation.x, _x.bounding_volume.pose.pose.orientation.y, _x.bounding_volume.pose.pose.orientation.z, _x.bounding_volume.pose.pose.orientation.w, _x.bounding_volume.dimensions.x, _x.bounding_volume.dimensions.y, _x.bounding_volume.dimensions.z, _x.width, _x.depth, _x.height))
      length = len(self.rgb)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.rgb))
      length = len(self.cielab)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.cielab))
      _x = self
      buff.write(_get_struct_4dB().pack(_x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized))
      _x = self.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      length = len(self.image_indices)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.image_indices))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.centroid.x, _x.centroid.y, _x.centroid.z, _x.center.x, _x.center.y, _x.center.z, _x.bounding_volume.pose.header.seq, _x.bounding_volume.pose.header.stamp.secs, _x.bounding_volume.pose.header.stamp.nsecs,) = _get_struct_6d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.bounding_volume.pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.bounding_volume.pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 104
      (_x.bounding_volume.pose.pose.position.x, _x.bounding_volume.pose.pose.position.y, _x.bounding_volume.pose.pose.position.z, _x.bounding_volume.pose.pose.orientation.x, _x.bounding_volume.pose.pose.orientation.y, _x.bounding_volume.pose.pose.orientation.z, _x.bounding_volume.pose.pose.orientation.w, _x.bounding_volume.dimensions.x, _x.bounding_volume.dimensions.y, _x.bounding_volume.dimensions.z, _x.width, _x.depth, _x.height,) = _get_struct_13d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.rgb = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.cielab = s.unpack(str[start:end])
      _x = self
      start = end
      end += 33
      (_x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized,) = _get_struct_4dB().unpack(str[start:end])
      ...
      self.image_indices = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.rgb.tostring())
      length = len(self.cielab)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.cielab.tostring())
      _x = self
      buff.write(_get_struct_4dB().pack(_x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized))
      _x = self.name
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.image_indices.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.rgb = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.cielab = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 33
      (_x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized,) = _get_struct_4dB().unpack(str[start:end])
      ...
      self.image_indices = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
