...
class RecognizeObjectActionResult(genpy.Message):
  _md5sum = "0199dda65ece9323b0fcaa801629b58e"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6d3I().pack(_x.result.object.centroid.x, _x.result.object.centroid.y, _x.result.object.centroid.z, _x.result.object.center.x, _x.result.object.center.y, _x.result.object.center.z, _x.result.object.bounding_volume.pose.header.seq, _x.result.object.bounding_volume.pose.header.stamp.secs, _x.result.object.bounding_volume.pose.header.stamp.nsecs))
      _x = self.result.object.bounding_volume.pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_13d().pack(_x.result.object.bounding_volume.pose.pose.position.x, _x.result.object.bounding_volume.pose.pose.position.y, _x.result.object.bounding_volume.pose.pose.position.z, _x.result.object.bounding_volume.pose.pose.orientation.x, _x.result.object.bounding_volume.pose.pose.orientation.y, _x.result.object.bounding_volume.pose.pose.orientation.z, _x.result.object.bounding_volume.pose.pose.orientation.w, _x.result.object.bounding_volume.dimensions.x, _x.result.object.bounding_volume.dimensions.y, _x.result.object.bounding_volume.dimensions.z, _x.result.object.width, _x.result.object.depth, _x.result.object.height))
      length = len(self.result.object.rgb)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.result.object.rgb))
      length = len(self.result.object.cielab)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.result.object.cielab))
      _x = self
      buff.write(_get_struct_4dB().pack(_x.result.object.orientation.x, _x.result.object.orientation.y, _x.result.object.orientation.z, _x.result.object.orientation.w, _x.result.object.recognized))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.object.marker.mesh_use_embedded_materials
      buff.write(_get_struct_B().pack(_x))
      length = len(self.result.object.image_indices)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.result.object.image_indices))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.object.point_cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.image.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (_x.result.object.centroid.x, _x.result.object.centroid.y, _x.result.object.centroid.z, _x.result.object.center.x, _x.result.object.center.y, _x.result.object.center.z, _x.result.object.bounding_volume.pose.header.seq, _x.result.object.bounding_volume.pose.header.stamp.secs, _x.result.object.bounding_volume.pose.header.stamp.nsecs,) = _get_struct_6d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.object.bounding_volume.pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.object.bounding_volume.pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 104
      (_x.result.object.bounding_volume.pose.pose.position.x, _x.result.object.bounding_volume.pose.pose.position.y, _x.result.object.bounding_volume.pose.pose.position.z, _x.result.object.bounding_volume.pose.pose.orientation.x, _x.result.object.bounding_volume.pose.pose.orientation.y, _x.result.object.bounding_volume.pose.pose.orientation.z, _x.result.object.bounding_volume.pose.pose.orientation.w, _x.result.object.bounding_volume.dimensions.x, _x.result.object.bounding_volume.dimensions.y, _x.result.object.bounding_volume.dimensions.z, _x.result.object.width, _x.result.object.depth, _x.result.object.height,) = _get_struct_13d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.result.object.rgb = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.result.object.cielab = s.unpack(str[start:end])
      _x = self
      start = end
      end += 33
      (_x.result.object.orientation.x, _x.result.object.orientation.y, _x.result.object.orientation.z, _x.result.object.orientation.w, _x.result.object.recognized,) = _get_struct_4dB().unpack(str[start:end])
      ...
      if python3:
        self.result.object.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.marker.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.marker.ns = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.marker.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.object.marker.mesh_resource = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.result.object.image_indices = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.result.object.rgb.tostring())
      length = len(self.result.object.cielab)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.result.object.cielab.tostring())
      _x = self
      buff.write(_get_struct_4dB().pack(_x.result.object.orientation.x, _x.result.object.orientation.y, _x.result.object.orientation.z, _x.result.object.orientation.w, _x.result.object.recognized))
      _x = self.result.object.name
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.result.object.image_indices.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.result.object.rgb = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.result.object.cielab = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 33
      (_x.result.object.orientation.x, _x.result.object.orientation.y, _x.result.object.orientation.z, _x.result.object.orientation.w, _x.result.object.recognized,) = _get_struct_4dB().unpack(str[start:end])
      ...
      self.result.object.image_indices = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
