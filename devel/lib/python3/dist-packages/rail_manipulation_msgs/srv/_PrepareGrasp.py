...
class PrepareGraspRequest(genpy.Message):
  ...
  _full_text = """geometry_msgs/PoseStamped graspPose  # Requested grasp pose
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.graspPose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
...
class PrepareGraspResponse(genpy.Message):
  ...
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool success                         # true if planner is ready to attempt the requested grasp
"""
  __slots__ = ['success']
  _slot_types = ['bool']
