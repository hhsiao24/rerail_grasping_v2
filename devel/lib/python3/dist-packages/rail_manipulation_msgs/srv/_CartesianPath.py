...
class CartesianPathRequest(genpy.Message):
  ...
  _full_text = """geometry_msgs/PoseStamped[] waypoints  # waypoints to plan Cartesian paths through (planning starts from current arm position)
...
class CartesianPathResponse(genpy.Message):
  ...
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool success                    # true if a path was planned successfully
