...
"""autogenerated by genpy from fetch_grasp_suggestion/RankedGraspList.msg. Do not edit."""
import codecs
import sys
...
class RankedGraspList(genpy.Message):
  _md5sum = "f5b8f589c172fed659a143976a7fe29c"
  _type = "fetch_grasp_suggestion/RankedGraspList"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """fetch_grasp_suggestion/RankedGrasp[] grasps  # ranked list of grasps
...
float64 w
"""
  __slots__ = ['grasps','object_index']
  _slot_types = ['fetch_grasp_suggestion/RankedGrasp[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RankedGraspList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.object_index,) = _get_struct_i().unpack(str[start:end])
      return self
