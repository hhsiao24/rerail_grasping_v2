...
"""autogenerated by genpy from fetch_grasp_suggestion/PresetMoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PresetMoveActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "fetch_grasp_suggestion/PresetMoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetch_grasp_suggestion/PresetMoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PresetMoveActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = fetch_grasp_suggestion.msg.PresetMoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = fetch_grasp_suggestion.msg.PresetMoveFeedback()
