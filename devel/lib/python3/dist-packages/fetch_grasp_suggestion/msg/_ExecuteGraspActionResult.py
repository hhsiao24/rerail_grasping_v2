...
"""autogenerated by genpy from fetch_grasp_suggestion/ExecuteGraspActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecuteGraspActionResult(genpy.Message):
  _md5sum = "8c1b2c6838f773882728e132cdb3c2f7"
  _type = "fetch_grasp_suggestion/ExecuteGraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetch_grasp_suggestion/ExecuteGraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteGraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fetch_grasp_suggestion.msg.ExecuteGraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fetch_grasp_suggestion.msg.ExecuteGraspResult()
