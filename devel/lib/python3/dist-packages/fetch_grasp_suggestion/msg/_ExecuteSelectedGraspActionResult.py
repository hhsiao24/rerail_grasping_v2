...
"""autogenerated by genpy from fetch_grasp_suggestion/ExecuteSelectedGraspActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecuteSelectedGraspActionResult(genpy.Message):
  _md5sum = "8c1b2c6838f773882728e132cdb3c2f7"
  _type = "fetch_grasp_suggestion/ExecuteSelectedGraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetch_grasp_suggestion/ExecuteSelectedGraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteSelectedGraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fetch_grasp_suggestion.msg.ExecuteSelectedGraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fetch_grasp_suggestion.msg.ExecuteSelectedGraspResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B2i().pack(_x.result.success, _x.result.error_code, _x.result.failure_point))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.error_code, _x.result.failure_point,) = _get_struct_B2i().unpack(str[start:end])
