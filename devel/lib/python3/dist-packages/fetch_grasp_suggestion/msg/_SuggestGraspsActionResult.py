...
"""autogenerated by genpy from fetch_grasp_suggestion/SuggestGraspsActionResult.msg. Do not edit."""
import codecs
import sys
...
class SuggestGraspsActionResult(genpy.Message):
  _md5sum = "297175328368493254b0fa19abbca43f"
  _type = "fetch_grasp_suggestion/SuggestGraspsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetch_grasp_suggestion/SuggestGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SuggestGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fetch_grasp_suggestion.msg.SuggestGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fetch_grasp_suggestion.msg.SuggestGraspsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.grasp_list.grasps)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp_list.grasps:
        _v1 = val1.pose
        _v2 = _v1.header
        _x = _v2.seq
      ...
      _x = self.result.grasp_list.object_index
      buff.write(_get_struct_i().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.grasp_list.grasps.append(val1)
      start = end
      end += 4
      (self.result.grasp_list.object_index,) = _get_struct_i().unpack(str[start:end])
      return self
